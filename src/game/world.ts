...
// The letter rests on the wall shelf. The player enters from the bottom and
// walks up toward the shelf to reach and open it.
export const LETTER_SPOT = { x: SHELF.x, y: 320, r: 210 };
